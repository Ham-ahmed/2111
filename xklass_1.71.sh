...
echo -e "${CYAN}"
echo "################################################################"
echo "#         Start downloading and installing  xklass_1.71        #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/2111/refs/heads/main/enigma2-plugin-extensions-xklass_1.71.20251119_all.ipk"
IPK_NAME="enigma2-plugin-extensions-xklass_1.71.20251119_all.ipk"
